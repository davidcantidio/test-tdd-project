    ...
    def test_product_visions_insert_and_query(self, migrated_db):
        ...
        cursor.execute("""
            INSERT INTO product_visions (
                project_id, vision_key, vision_statement,
                success_metrics, strategic_goals
            ) VALUES (
                1, 'vision_1', 'A test product vision',
        ...
        assert result[3] == 'A test product vision', "Vision statement incorreto"
